...
public partial class p16 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<table cellpadding=10 cellspacing=10>");
        ...
        for (int i = 0; i < ds.Tables["Products"].Rows.Count; i++)
        {
            ...
            Response.Write("<td>" + ds.Tables[0].Rows[i].ItemArray.GetValue(1).ToString() + "</td>");
            Response.Write("<td>" + ds.Tables[0].Rows[i].ItemArray.GetValue(2).ToString() + "</td></tr>");
        }
